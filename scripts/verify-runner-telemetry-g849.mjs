 ...
 *
 * This script provides functionality to verify runner telemetry by fetching
 * health and efficiency data from BuilderOS and LifeOS control planes.
 * It exports an async function for use within the governed loop.
 */
 ...
 */
export async function runRunnerTelemetryG849Verification({ baseUrl, commandKey }) {
  ...
  if (cpResult.error || effResult.error) {
    return {
      ...
      details: {
        controlPlane: cpResult.data || null,
        efficiency: effResult.data || null
      },
  ...
  return {
    ok: true,
    generation: 849,
    session_tasks_done: 892,
    session_successful: 698,
    session_failed: 607,
