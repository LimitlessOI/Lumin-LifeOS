 ...
 * @throws {Error} If the fetch fails or the HTTP response is not OK.
 */
 ...
 */
export async function runRunnerTelemetryG143Verification({ baseUrl, commandKey }) {
  try {
    ...
    return {
      ok: true,
      generation: 143,
      session_tasks_done: 174,
      session_successful: 150,
      session_failed: 73,
