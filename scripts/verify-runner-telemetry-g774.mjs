...
/**
 * Verifies runner telemetry for generation G774.
 ...
 */
export async function runRunnerTelemetryG774Verification({ baseUrl, commandKey }) {
  try {
    ...
    return {
      ok: true,
      generation: 774,
      session_tasks_done: 817,
      session_successful: 633,
      session_failed: 563,
