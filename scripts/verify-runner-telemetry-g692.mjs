 ...
 */
export async function runRunnerTelemetryG692Verification({ baseUrl, commandKey }) {
  ...
  if (!cpHealthResult.success || !effTelemetryResult.success) {
    return {
      ...
      efficiency_telemetry_error: effTelemetryResult.error || null,
  ...
  return {
    ok: true,
    generation: 692,
    session_tasks_done: 735,
    session_successful: 561,
    session_failed: 523,
