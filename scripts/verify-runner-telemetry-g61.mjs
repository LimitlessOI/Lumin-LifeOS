...
/**
 * Verifies runner telemetry for generation 61 by fetching control plane health and efficiency data.
 ...
 */
export async function runRunnerTelemetryG61Verification({ baseUrl, commandKey }) {
