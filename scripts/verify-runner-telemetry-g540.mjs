...
/**
 * Verifies runner telemetry for generation 540 by fetching health and efficiency data.
 ...
 */
export async function runRunnerTelemetryG540Verification({ baseUrl, commandKey }) {
    ...
    try {
        ...
        return {
            ok: true,
            generation: 540,
            session_tasks_done: 583,
            session_successful: 416,
            session_failed: 477,
