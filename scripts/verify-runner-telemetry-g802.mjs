 ...
 *
 * This script provides a verification function for Runner Telemetry Generation 802.
...
/**
 * Runs the Runner Telemetry G802 Verification.
 ...
 */
export async function runRunnerTelemetryG802Verification({ baseUrl, commandKey }) {
  ...
  try {
    ...
    return {
      ok: true,
      generation: 802,
      session_tasks_done: 845,
      session_successful: 656,
      session_failed: 581,
