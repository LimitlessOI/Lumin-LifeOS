...
/**
 * Verifies runner telemetry for generation 304 by fetching control plane health
 ...
 */
export async function runRunnerTelemetryG304Verification({ baseUrl, commandKey }) {
    ...
    return {
        ok: true,
        generation: 304,
        session_tasks_done: 347,
        session_successful: 194,
        session_failed: 371,
