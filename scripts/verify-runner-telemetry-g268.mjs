 ...
 */
export async function runRunnerTelemetryG268Verification({ baseUrl, commandKey }) {
    ...
    try {
        ...
        return {
            ok: false,
            error: `Failed to verify runner telemetry: ${error.message}`,
            checked_at: new Date().toISOString()
        };
    }
}