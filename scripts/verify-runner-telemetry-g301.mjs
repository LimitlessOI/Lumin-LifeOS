...
/**
 * Runs a telemetry verification for Runner G301, fetching health and efficiency data.
 ...
 */
export async function runRunnerTelemetryG301Verification({ baseUrl, commandKey }) {
    ...
    try {
        ...
        return {
            ok: true,
            generation: 301,
            session_tasks_done: 344,
            session_successful: 191,
            session_failed: 371,
