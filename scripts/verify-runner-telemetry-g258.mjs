 ...
 */
export async function runRunnerTelemetryG258Verification({ baseUrl, commandKey }) {
  ...
  return {
    ok: true,
    generation: 258,
    session_tasks_done: 301, // Updated value
    session_successful: 153, // Updated value
    session_failed: 349,     // Updated value
