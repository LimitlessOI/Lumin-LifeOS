 ...
 * Handles network errors and non-2xx HTTP responses gracefully.
 ...
 */
export async function runRunnerTelemetryG295Verification({ baseUrl, commandKey }) {
