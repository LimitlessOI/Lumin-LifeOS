...
/**
 * Verifies runner telemetry for generation 311 by fetching control plane health
 ...
 */
export async function runRunnerTelemetryG311Verification({ baseUrl, commandKey }) {
  ...
  return {
    ok: true,
    generation: 311,
    session_tasks_done: 354,
    session_successful: 201,
    session_failed: 371,
