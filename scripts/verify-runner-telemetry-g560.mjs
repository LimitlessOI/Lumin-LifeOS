...
/**
 * Verifies runner telemetry for generation G560 by fetching health and efficiency data.
 *
 ...
 */
export async function runRunnerTelemetryG560Verification({ baseUrl, commandKey }) {
    ...
    try {
        ...
        return {
            ok: true,
            generation: 560,
            session_tasks_done: 603,
            session_successful: 433,
            session_failed: 490,
