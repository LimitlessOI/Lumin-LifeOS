 ...
 * It uses native fetch to interact with LifeOS internal APIs.
 */
 ...
 */
export async function runRunnerTelemetryG664Verification({ baseUrl, commandKey }) {
  ...
  return {
    ok: true,
    generation: 664,
    session_tasks_done: 707,
    session_successful: 534,
    session_failed: 513,
