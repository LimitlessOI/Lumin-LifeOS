...
/**
 * Runs a verification check for runner telemetry generation 472.
 ...
 */
export async function runRunnerTelemetryG472Verification({ baseUrl, commandKey }) {
  ...
  try {
    ...
    return {
      ok: true,
      generation: 472,
      session_tasks_done: 515,
      session_successful: 353,
      session_failed: 446,
