...
/**
 * Runs a telemetry verification for runner generation 449.
 ...
 */
export async function runRunnerTelemetryG449Verification({ baseUrl, commandKey }) {
    ...
    try {
        ...
        return {
            ok: true,
            generation: 449,
            session_tasks_done: 492,
            session_successful: 331,
            session_failed: 435,
