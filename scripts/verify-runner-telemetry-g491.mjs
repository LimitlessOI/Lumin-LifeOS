 ...
 * specifically for generation 491. It fetches health and efficiency
...
/**
 * Runs a verification check for runner telemetry generation 491.
 ...
 */
export async function runRunnerTelemetryG491Verification({ baseUrl, commandKey }) {
  ...
  return {
    ok: true,
    generation: 491,
    session_tasks_done: 534,
    session_successful: 372,
    session_failed: 450,
