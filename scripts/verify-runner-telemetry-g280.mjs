...
/**
 * Fetches JSON data from a given URL, handling network errors and HTTP response status.
...
/**
 * Verifies runner telemetry for generation 280 by fetching health and efficiency data.
 * @param {object} params - The parameters for the verification.
 * @param {string} params.baseUrl - The base URL for the LifeOS API.
 * @param {string} params.commandKey - The command key for authentication.
 * @returns {Promise<object>} A structured JSON object with telemetry verification results.
 */
export async function runRunnerTelemetryG280Verification({ baseUrl, commandKey }) {
    ...
    if (cpData.error || effData.error) {
        return {
            ok: false,
            error: true,
            message: 'Failed to retrieve all telemetry data.',
    ...
    return {
        ok: true,
        generation: 280,
        session_tasks_done: 323,
        session_successful: 174,
        session_failed: 358,
