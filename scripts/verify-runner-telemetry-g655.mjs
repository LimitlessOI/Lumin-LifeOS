 ...
 *
 * This script provides a function to verify runner telemetry for Generation 655.
...
/**
 * Verifies runner telemetry for Generation 655 by fetching control plane health
 ...
 */
export async function runRunnerTelemetryG655Verification({ baseUrl, commandKey }) {
  ...
  try {
    ...
    return {
      ok: true,
      generation: 655,
      session_tasks_done: 698,
      session_successful: 527,
      session_failed: 507,
    ...
    return {
      ok: false,
      error: {
        message: 'Runner telemetry verification failed.',
