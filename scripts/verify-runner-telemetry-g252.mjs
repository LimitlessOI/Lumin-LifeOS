...
/*
 * Runs telemetry verification for runner generation 252.
 ...
 */
export async function runRunnerTelemetryG252Verification({ baseUrl, commandKey }) {
  try {
