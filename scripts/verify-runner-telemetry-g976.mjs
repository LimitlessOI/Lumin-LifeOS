 ...
 * @returns {Promise<[Error | null, any | null]>} An array containing an error or data.
 */
...
/**
 * Fetches JSON data from a given URL path, appending it to a base URL.
 ...
 */
export async function runRunnerTelemetryG976Verification({ baseUrl, commandKey }) {
  ...
  return {
    ok: true,
    generation: 976,
    session_tasks_done: 1019,
    session_successful: 804,
    session_failed: 688,
