 ...
 *
 * This script verifies the operational telemetry of the runner by fetching
 * health and efficiency data from the BuilderOS control plane and LifeOS
 ...
 */
export async function runRunnerTelemetryG159Verification({ baseUrl, commandKey }) {
