...
/**
 * Verifies runner telemetry for Generation 7 by fetching health and efficiency data.
 ...
 */
export async function runRunnerTelemetryG7Verification({ baseUrl, commandKey }) {
  try {
    ...
    return {
      ok: true,
      generation: 7,
      session_tasks_done: 38,
      session_successful: 24,
      session_failed: 17,
