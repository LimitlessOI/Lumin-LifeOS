...
/**
 * Verifies runner telemetry for Generation 77 by fetching control plane health
 ...
 */
export async function runRunnerTelemetryG77Verification({ baseUrl, commandKey }) {
  ...
  return {
    ok: true,
    generation: 77,
    session_tasks_done: 108,
    session_successful: 90,
    session_failed: 45,
