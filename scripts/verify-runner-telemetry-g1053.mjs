...
/**
 * Wraps an async promise in a try-catch block to return an array [error, data].
 ...
 */
export async function runRunnerTelemetryG1053Verification({ baseUrl, commandKey }) {
  ...
  return {
    ok: true,
    generation: 1053,
    session_tasks_done: 1096,
    session_successful: 873,
    session_failed: 728,
