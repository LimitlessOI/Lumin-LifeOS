...
/**
 * Fetches JSON data from a specified URL path with a given command key header.
 ...
 */
export async function runRunnerTelemetryG515Verification({ baseUrl, commandKey }) {
    ...
    try {
        ...
        return {
            ok: true,
            generation: 515,
            session_tasks_done: 558,
            session_successful: 394,
            session_failed: 462,
