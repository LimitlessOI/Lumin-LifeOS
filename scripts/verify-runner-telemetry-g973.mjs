 ...
 */
export async function runRunnerTelemetryG973Verification({ baseUrl, commandKey }) {
  ...
  try {
    ...
    console.error('Telemetry verification failed:', error.message);
    return {
      ok: false,
