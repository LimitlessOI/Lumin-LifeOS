...
/**
 * Verifies runner telemetry for generation 563 by fetching health and efficiency data.
 *
 ...
 */
export async function runRunnerTelemetryG563Verification({ baseUrl, commandKey }) {
  ...
  try {
    ...
    return {
      ok: true,
      generation: 563,
      session_tasks_done: 606,
      session_successful: 436,
      session_failed: 491,
