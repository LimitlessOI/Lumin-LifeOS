...
async function fetchJson(baseUrl, path, commandKey) {
  ...
  if (!response.ok) {
    ...
    throw new Error(`API call to ${path} failed with status ${response.status}: ${errorText}`);
  }
 ...
 */
export async function runRunnerTelemetryG966Verification({ baseUrl, commandKey }) {
  ...
  try {
    ...
    return {
      ok: true,
      generation: 966,
      session_tasks_done: 1009,
      session_successful: 796,
      session_failed: 683,
