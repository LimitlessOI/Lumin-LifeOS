/**
 * SYNOPSIS: Exports runGAP022GapVerification — scripts/verify-gap-022-gap.mjs.
...
export async function runGAP022GapVerification({ baseUrl, commandKey }) {
  ...
  try {
    ...
    return {
      ok: true,
      gap_id: 'GAP-022',
      gap_description: "Memory lessons not auto-captured from builder failures/successes",
      gap_priority: "P2",
      gap_status: "1-week",
