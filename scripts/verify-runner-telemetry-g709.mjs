...
/**
 * Runs telemetry verification for generation 709, fetching control plane health
 ...
 */
export async function runRunnerTelemetryG709Verification({ baseUrl, commandKey }) {
  ...
  return {
    ok: true,
    generation: 709,
    session_tasks_done: 752,
    session_successful: 578,
    session_failed: 530,
