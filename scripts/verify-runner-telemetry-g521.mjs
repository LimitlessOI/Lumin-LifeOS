 ...
 */
export async function runRunnerTelemetryG521Verification({ baseUrl, commandKey }) {
    ...
    try {
        ...
        return {
            ok: false,
            error: `Failed to fetch runner telemetry: ${error.message}`,
            checked_at: new Date().toISOString()
        };
    }
    ...
    return {
        ok: true,
        generation: 521,
        session_tasks_done: 564,
        session_successful: 399,
        session_failed: 467,
