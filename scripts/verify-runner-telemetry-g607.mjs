...
/**
 * Verifies runner telemetry for generation 607 by fetching health and efficiency data.
 ...
 */
export async function runRunnerTelemetryG607Verification({ baseUrl, commandKey }) {
  ...
  try {
    ...
    return {
      ok: true,
      generation: 607,
      session_tasks_done: 650,
      session_successful: 480,
      session_failed: 497,
