...
/**
 * Verifies runner telemetry for Generation 595 by concurrently fetching
 ...
 */
export async function runRunnerTelemetryG595Verification({ baseUrl, commandKey }) {
  ...
  if (cpError || effError) {
    return {
      ...
      error: cpError ? cpError.message : effError.message,
  ...
  return {
    ok: true,
    generation: 595,
    session_tasks_done: 638,
    session_successful: 468,
    session_failed: 497,
