 ...
 */
export async function runRunnerTelemetryG432Verification({ baseUrl, commandKey }) {
    ...
    try {
        ...
        return { ok: false, error: `Failed to fetch telemetry data: ${e.message}` };
    }

    return {
        ok: true,
        generation: 432,
        session_tasks_done: 475,
        session_successful: 316,
        session_failed: 425,
