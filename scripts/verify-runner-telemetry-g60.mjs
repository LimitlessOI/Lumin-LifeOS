...
/**
 * Verifies runner telemetry for Generation 60 by fetching health and efficiency data.
 ...
 */
export async function runRunnerTelemetryG60Verification({ baseUrl, commandKey }) {
  let cpData = {};
  let effData = {};
