...
/**
 * Verifies runner telemetry for generation G306 by fetching control plane health
 ...
 */
export async function runRunnerTelemetryG306Verification({ baseUrl, commandKey }) {
