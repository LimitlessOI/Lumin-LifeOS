 ...
 */
export async function runRunnerTelemetryG495Verification({ baseUrl, commandKey }) {
    ...
    try {
        ...
        return { ok: false, error: `Telemetry fetch failed: ${error.message}`, checked_at: new Date().toISOString() };
    }

    return {
        ok: true,
        generation: 495,
        session_tasks_done: 538,
        session_successful: 376,
        session_failed: 451,
