...
/**
 * Verifies runner telemetry for Generation 650 by fetching control plane health
 ...
 */
export async function runRunnerTelemetryG650Verification({ baseUrl, commandKey }) {
    ...
    return {
        ok: true,
        generation: 650,
        session_tasks_done: 693,
        session_successful: 522,
        session_failed: 505,
