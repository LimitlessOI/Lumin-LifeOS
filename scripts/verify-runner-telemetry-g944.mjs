...
/**
 * Runs the telemetry verification for runner generation 944.
 ...
 */
export async function runRunnerTelemetryG944Verification({ baseUrl, commandKey }) {
  try {
    ...
    return {
      ok: true,
      generation: 944,
      session_tasks_done: 987,
      session_successful: 777,
      session_failed: 668,
