...
**Mandate completion (North Star §2.17 — NON-NEGOTIABLE):** **Phase A (opposition):** Adam **does not know what he does not know** — surface clear assumptions; **oppose** weak/destructive paths **with solutions** (assumption · risk · alternative · proof). **Yes-ma'am = failure.** **Phase B (after lock):** execute with proof or **UNSOLVED**; no substitute; no re-litigating. Before **COMPLETE**, run the objective proof command if one exists.
...
- [`00-OPERATOR-MANDATE-COMPLETION.md`](00-OPERATOR-MANDATE-COMPLETION.md) — **§2.17** pass/fail bar; run proof before **COMPLETE**.  
