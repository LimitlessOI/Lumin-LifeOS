...
**Project:** LifeOS  
**Status:** Pre-build — archaeology complete, BPB next, execute blocked on billing  
**Last updated:** 2026-06-09  

> **This is the document you dump into.** Brainstorm, decisions, salvage, scope, non-goals — all land here.  
> **Terminology:** `docs/BUILDEROS_VOCABULARY.md` (language law).  
> **BPB reads this and produces `BLUEPRINT.json`.** PSSOT is not a blueprint.
