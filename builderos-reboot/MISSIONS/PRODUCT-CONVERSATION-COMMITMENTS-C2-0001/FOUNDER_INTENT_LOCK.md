...
Every extracted commitment preserves: source conversation, source quote, timestamp, confidence, extraction method. User can always ask: **“Why does LifeOS think this commitment exists?”** See `FOUNDER_PACKET.md` § Evidence First Law.
