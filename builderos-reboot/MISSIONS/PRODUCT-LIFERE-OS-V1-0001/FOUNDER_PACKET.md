...
## Desired Outcome
Adam opens LifeRE alpha, sees daily command center, top-3 priorities, and nightly debrief draft — without Cursor

## FOUNDER SUCCESS TEST
Open /overlay/lifeos-app.html LifeRE path; complete one daily command center cycle; confirm top-3 and debrief visible
