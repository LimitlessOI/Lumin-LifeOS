...
4. **Multi-horizon future-back** — For each horizon (**1 year**, **2 years**, **4 years**, **5 years**): assume this shipped; what worked, broke, wish we had known; what to instrument now.
5. **Competitive / external scan** — What do peers or the market do? Improve, integrate, or reject — with fit to our architecture.
6. **Synthesis (Position E/K)** — Is there an option **beyond A vs B** (a reframe or hybrid) that survives pushback? Name it explicitly if yes.
7. **Recommendation** — Clear stance.
...
- If asked for **synthesis**, propose Position E/K explicitly before your final VERDICT line.
