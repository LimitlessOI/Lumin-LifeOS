<!-- SYNOPSIS: LifeOS Domain Prompt Files -->
...
| `00-SYSTEM-AUTHORITY-LAYERS.md` | **Read early** — Factory vs production spine; path to `AGENTS.md` boundaries | Blueprint pack + HANDOFF |
