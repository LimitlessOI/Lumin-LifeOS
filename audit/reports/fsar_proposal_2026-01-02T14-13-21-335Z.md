...
- id: fsar_e418e493-7ecb-4ef8-8693-f31330fb52e4
- timestamp: 2026-01-02T14:13:21.335Z
- severity: 6
...
services:
  webapp:
    image: railway/lifeos-courses:latest
    ports:
      - "8080:80"
    environment:
      DATABASE_URL: postgres://postgres@db/railway?sslmode=require
