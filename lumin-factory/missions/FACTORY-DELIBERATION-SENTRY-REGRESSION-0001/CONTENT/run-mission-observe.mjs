...
const objectiveScore = recovery?.objective_score ?? (artifacts.SENTRY_CHECK_RESULT ? 'PARTIAL' : 'FAIL');
...
const row = {
  ...
  recovery_next_route: recovery?.next_route,
...
process.exit(objectiveScore === 'PASS' ? 0 : 1);
