...
**2026-06-10 security hotfix in progress:** standalone
...
still succeeds, traversal is blocked, and byte-exact SHA mismatch does not write a target. Next
proof: `npm run factory:ci` from this `lumin-factory/` root.
