/**
 * SYNOPSIS: Set CORS headers for all responsesif(!process.env.NODE_ENV) {console.error("You are in development mode");} app.options('*', cors()); const apiRoutes = require('./routes/api'); // Register API routesapp.use('/api/v1', apiRoutes);
 */
