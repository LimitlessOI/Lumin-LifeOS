...
-- Create table for scheduling posts on social platforms (PostgreSQL idempotent).
...
CREATE INDEX IF NOT EXISTS idx_platform_name ON social_platform_scheduling(platform_name);
