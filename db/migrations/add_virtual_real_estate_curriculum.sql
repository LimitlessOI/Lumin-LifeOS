...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE students
      ...
      FOREIGN KEY (curriculum_id) REFERENCES real_estate_curriculum(id) ON DELETE SET NULL;
  END IF;
END $$;
CREATE TABLE IF NOT EXISTS curriculum_modules (
    ...
    CONSTRAINT curriculum_modules_curriculum_id_fkey
      FOREIGN KEY (curriculum_id) REFERENCES real_estate_curriculum(id) ON DELETE CASCADE
);
