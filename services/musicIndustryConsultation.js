...
export function getMusicIndustryConsultations(deps, payload) {
  return checkMusicIndustryConsultations(deps, payload);
}

export function addIndustryConsult(deps, payload) {
  return checkMusicIndustryConsultations(deps, payload);
}

export function getIndustryConsult(deps, payload) {
  return checkMusicIndustryConsultations(deps, payload);
}
