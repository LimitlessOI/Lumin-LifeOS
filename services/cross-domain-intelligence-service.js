/**
 * SYNOPSIS: Cross-Domain Personal Intelligence -- per-domain data silos,
 * explicit cross-domain consent, audit logging, and multi-domain inference
 * under founder authority. Ported from the proven prototype
 * (scripts/prototype-cross-domain-v5.mjs, 12/12 tests) -- same algorithm, no
 * changes to consent/inference logic.
