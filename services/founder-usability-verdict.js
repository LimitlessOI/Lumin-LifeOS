...
const IMPERATIVE_SIGNOFF = /\b(sign(?:ed)?\s*off|approve[d]?|good to go|ship it)\b/i;
...
const USABILITY_CONTEXT = /\b(sign(?:ed)?\s*off|approve[d]?|good to go|ship it|usable|i tested|(?:i )?signed up|(?:i )?logged in|for me|i tried|works for me|usability)\b/i;
