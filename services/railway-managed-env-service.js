...
const DEFAULT_ALLOWED_KEYS = new Set([
  ...
  "FOUNDER_PAYMENT_CARD_NUMBER",
  "FOUNDER_PAYMENT_CARD_EXP",
  "FOUNDER_PAYMENT_CARD_CVC",
  "FOUNDER_PAYMENT_CARD_NAME",
  "FOUNDER_PAYMENT_BILLING_ZIP",
  "LIFEOS_FOUNDER_LOGIN_EMAIL",
  "LIFEOS_FOUNDER_LOGIN_PASSWORD",
  "LIFEOS_FOUNDER_LOGIN_HANDLE",
  "WORK_EMAIL",
  ...
  "PERPLEXITY_API_KEY",
  "BUILDEROS_AUTOPILOT",
  "BUILDEROS_AUTOPILOT_INTERVAL_MS",
  "BUILDEROS_AUTOPILOT_BOOT_DELAY_MS",
  "BUILDEROS_AUTOPILOT_RECENT_WINDOW_MS",
  "BUILDEROS_NEVER_STOP",
  "NEVER_STOP_PRODUCTS",
  "NEVER_STOP_INTERVAL_MS",
  "BUILDEROS_NEVER_STOP_INTERVAL_MS",
  "NEVER_STOP_DAILY_STEP_CAP",
  "NEVER_STOP_BOOT_DELAY_MS",
  "NEVER_STOP_LANES",
  "LIVE_SOCIAL_PUBLISH_ENABLED",
  ...
  "LIFEOS_ENABLE_FULL_RUNTIME",
  "LIFEOS_ALLOW_FULL_RUNTIME_ON_RAILWAY",
  "LIFEOS_ENABLE_FIELD_OPS_ROUTES",
  "LIFEOS_ENABLE_EXTERNAL_PRODUCT_ROUTES",
