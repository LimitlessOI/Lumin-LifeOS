...
import {
  ...
  validatePostmarkWebhook, // Added import
  validateTwilioWebhook,   // Added import
...
const listingTdSkyslopeJobs = new Map(); // Moved from tc-communication-callback-service.js
