...
import { createTCCommunicationCallbackService, validatePostmarkWebhook, validateTwilioWebhook,
} from '../services/tc-communication-callback-service.js';
...
export function createTCRoutes(
  app,
  { pool, requireKey: rk, coordinator, logger = console, accountManager: injectedAccountManager = null, notificationService: injectedNotificationService = null, callCouncilMember: ccm = null, sendSMS = null, sendAlertSms = null, sendAlertCall = null, startAlertLoop = false, managedEnvService = null, } = {}
) {
