...
import { validatePostmarkWebhook, validateTwilioWebhook } from '../services/tc-webhook-validation-service.js'; // New import
...
const listingTdSkyslopeJobs = new Map(); // Moved up for consistency
const LISTING_SYNC_JOB_TTL_MS = 2 * 60 * 60 * 1000; // Moved up for consistency
...
function tdInspectionForwardPlaybook(recipientName) {
  ...
  return {
    ...
    known_plans: Object.keys(tdWorkflowRunner.TD_WORKFLOW_CATALOG || {}), // Assuming tdWorkflowRunner is available here
  };
}
