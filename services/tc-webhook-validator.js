...
import { createTCWebhookValidationService } from '../services/tc-webhook-validation-service.js'; // New import
...
const listingTdSkyslopeJobs = new Map(); // Moved from tc-webhook-validation-service.js
