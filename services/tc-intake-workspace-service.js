  ...
  async function listActiveTransactions(limit = 25) {
    ...
    return Promise.all(rows.map(async (transaction) => {
      ...
      return {
        ...
        closing_fee: transaction.closing_fee,
        setup_fee: transaction.setup_fee,
        fee_collected: transaction.fee_collected,
        fee_collected_amt: transaction.fee_collected_amt,
        closing_fee_note: transaction.closing_fee_note,
        stage: status.stage,
