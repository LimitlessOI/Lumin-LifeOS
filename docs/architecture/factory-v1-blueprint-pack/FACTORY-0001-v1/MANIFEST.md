...
2. `FOUNDER_PACKET.md`
3. `../FOUNDER_PACKET_TEMPLATE_V1.md`
4. `FOUNDER_PACKET_COMPLETENESS_CHECKLIST.md`
5. `PRODUCT_DEVELOPMENT_GATE.md`
6. `LESSONS_REGISTER.md`
7. `BLUEPRINT.json`
8. `ACCEPTANCE_TESTS.json`
9. `AUTHORITY_CHECK.json`
10. `SALVAGE_MAP.json`
11. `BLOCKED_RETURN_SCHEMA.json`
12. `../SALVAGE_CANDIDATES.json`
