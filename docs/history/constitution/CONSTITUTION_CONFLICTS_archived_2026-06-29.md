...
- `docs/products/lifeos/PRODUCT_HOME.md` §PRIORITY ALIGNMENT (operator directive 2026-05-03): "Adam declares LifeOS shipped + stabilized + approved backlog features working as program priority one."
...
- `docs/products/LIFEOS.md` exists, last state "2026-06-11." It opens by deferring to AMENDMENT_21 ("Amendment: `docs/products/lifeos/PRODUCT_HOME.md` (full history + receipts)") but still exists as a separate file.
- `services/voice-rail-v1.js` line 294: reads `docs/products/lifeos/PRODUCT_HOME.md` (was patched from the products path per AM21 Change Receipt 2026-06-11 — "readLifeOSProductBrief() read docs/products/LIFEOS.md which no longer exists").
...
- `docs/products/lifeos/PRODUCT_HOME.md` Change Receipt (2026-06-11): "§2.17 Operator mandate completion bar... `prompts/00-OPERATOR-MANDATE-COMPLETION.md` (NEW)... Adam directive: good instructions in → results out; subsystem wins ≠ completion."
