...
| **Hardship Protocol** | `docs/SSOT_NORTH_STAR.md` Art V-B | `docs/NORTH_STAR_EDUCATION_HEALING.md` §X; `docs/constitution/NORTH_STAR.md` Art V-B; `docs/products/lifeos/PRODUCT_HOME.md` §Pricing — Never Gate |
...
| **Product priority / revenue order** | `docs/SSOT_COMPANION.md` §0.4 (defers to QUICK_LAUNCH) | `docs/projects/INDEX.md` §PROJECT REGISTRY; `docs/products/lifeos/PRODUCT_HOME.md` §PRIORITY ALIGNMENT; memory/project_priority_order.md |
| **Agent inbox / AI dispute resolution** | `CLAUDE.md` §AGENT INBOX | `docs/AGENT_INBOX.md` |
| **LifeOS product law** | `docs/products/lifeos/PRODUCT_HOME.md` | `docs/products/LIFEOS.md` (separate doc — see Conflict C4) |
| **Deliberation / BPB/Council before build** | `docs/products/builderos/PRODUCT_HOME.md` | referenced from AM21 Change Receipts |
| **Token accounting** | `docs/products/token-accounting-os/PRODUCT_HOME.md` | `docs/SSOT_COMPANION.md` §12 (TCO) |
...
| **LifeOS build** | All of above + `docs/products/lifeos/PRODUCT_HOME.md` (owned by CLAUDE.md SSOT mapping) |
