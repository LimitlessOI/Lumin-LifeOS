...
|---|---|---|---|---|---|
| 2026-07-14 | **TD search harden** — iframe/CSS search fill, Transactions list URLs, listing sync uses `openTransactionDeskFile`. | Tip after TD SSO fix: `TransactionDesk search field not found`. | ✅ | | tip re-verify listing |
