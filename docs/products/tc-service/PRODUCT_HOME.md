...
|---|---|---|---|---|---|
| 2026-07-07 | **`core/notification-service.js`:** always force Gmail SMTP to port **465** when env says 587 (IPv4 connect + `tls.servername`). | Railway kept connecting to `:587` IPv6 despite prior Railway-only override. | ✅ | pending manifest | prod resend |
