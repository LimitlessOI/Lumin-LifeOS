...
| 2026-08-11 | **SECURITY: `routes/studentInterviewAnalyticsRoutes.js` requires `deps.requireKey`.** Unauthenticated `GET /student-interview-analytics/:id` closed. | Tip IDOR / public analytics read. | ✅ fail-closed register + requireKey middleware |
