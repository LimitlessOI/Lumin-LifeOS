...
| **Last Updated** | 2026-08-02 — `routes/white-label-routes.js` merged with builder refactor: imports `createWhiteLabelService`, registers `app.post('/api/v1/white-label/config')` and `app.get('/api/v1/white-label/config')`, exports `createWhiteLabelRoutes` and `registerWhiteLabelRoutes`; `db/migrations/20260802_create_partner_configurations.sql` provides the table used by the service.

---
**Status:** BUILDING
**Authority:** Subordinate to SSOT North Star Constitution
**Last Updated:** 2026-08-02 — `routes/white-label-routes.js` merged with builder refactor and partner_configurations migration.
