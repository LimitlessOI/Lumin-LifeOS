<!-- SYNOPSIS: Canonical product home — Enterprise AI Governance -->

# Enterprise AI Governance Product Home

**Formerly called:** Amendment 30 — ENTERPRISE AI GOVERNANCE

| Field | Value |
|---|---|
| **Canonical home** | this file |
| **Product id** | `enterprise-ai-governance` |
| **Constitutional law** | `docs/constitution/NORTH_STAR_SSOT.md` |
| **Machine manifest** | `docs/products/enterprise-ai-governance/FILE_MANIFEST.json` |
...
| **Manifest** | `docs/products/enterprise-ai-governance/FILE_MANIFEST.json` |
