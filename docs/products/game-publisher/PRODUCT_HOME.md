<!-- SYNOPSIS: Canonical product home — Game Publisher -->

# Game Publisher Product Home

**Formerly called:** Amendment 06 — GAME PUBLISHER

| Field | Value |
|---|---|
| **Canonical home** | this file |
| **Product id** | `game-publisher` |
| **Constitutional law** | `docs/constitution/NORTH_STAR_SSOT.md` |
| **Machine manifest** | `docs/products/game-publisher/FILE_MANIFEST.json` |
