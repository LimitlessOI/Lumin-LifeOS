...
| **Last Updated** | 2026-07-15 — Corrected Fix #1 same-day: live-verify caught that fail-closed-on-no-tenant would have locked Sherry out of her own dashboard (DEFAULT_TENANT has zero configured operators). Reverted to open-when-unconfigured, kept the tenant-scoped SQL fixes (#2/3/6/8) which are the actual cross-tenant protection. See Change Receipts. |
