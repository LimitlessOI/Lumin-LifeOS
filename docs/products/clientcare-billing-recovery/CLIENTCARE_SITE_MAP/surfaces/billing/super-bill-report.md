<!-- SYNOPSIS: ClientCare surface card — Super Bill Report -->

# SURFACE: Super Bill Report

| Field | Value |
|-------|-------|
| **Surface id** | `cc.billing.super_bill_report` |
| **Domain** | billing |
| **URL** | `/Billing/SuperBillReport` |
...
Procedure/Dx/fee grid; claims created column
...
| WRM LLC | `/Billing/SuperBillReport#` | no |
...
| Filter | `/Billing/SuperBillReport#` | no |
| Export | `javascript:void(0)` | no |
...
| Click Here to Continue Working | `/Billing/SuperBillReport#` | no |
...
Cora
Super Bill Report
Home / Reports / Super Bill Report
Filter 
 	Procedure		Dx Code	Fee	Note	Created Date	Claims Created	 
No Record(s) Found.
...
|------|--------|----------|
| 2026-07-15 | tip inspect | `_Billing_SuperBillReport.json` |
