<!-- SYNOPSIS: ClientCare surface card — Billing Slip / Charge Slip -->

# SURFACE: Billing Slip / Charge Slip

| Field | Value |
|-------|-------|
| **Surface id** | `cc.billing.charge_slip` |
| **Domain** | billing |
| **URL** | `/Company/ChargeSlip` |
...
Charge slip create + Daily Super bill
...
| Procedure | `/Services/Edit` | no |
| Procedure | `/Services/DiagnosisCodeEdit/` | no |
...
| Click Here to Continue Working | `/Company/ChargeSlip#` | no |
...
|------|--------|----------|
| 2026-07-15 | tip inspect | `_Company_ChargeSlip.json` |
