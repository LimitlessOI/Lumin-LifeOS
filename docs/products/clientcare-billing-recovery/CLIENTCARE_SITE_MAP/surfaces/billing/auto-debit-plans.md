<!-- SYNOPSIS: ClientCare surface card — Auto Debit Plans -->

# SURFACE: Auto Debit Plans

| Field | Value |
|-------|-------|
| **Surface id** | `cc.billing.auto_debit_plans` |
| **Domain** | billing |
| **URL** | `/Billing/AutoDebitPlanReport` |
...
| WRM LLC | `/Billing/AutoDebitPlanReport#` | no |
...
| Filter | `/Billing/AutoDebitPlanReport#` | no |
...
| Click Here to Continue Working | `/Billing/AutoDebitPlanReport#` | no |
...
Cora
Auto Debit Plans Report
Home / Reports / Auto Debit Plans Report
Filter 
	
Name	Start Date	Auto Debit Total	
Payment
	Status	Intervals	Total to Date	Invoice Balance	Telephone
...
|------|--------|----------|
| 2026-07-15 | tip inspect | `_Billing_AutoDebitPlanReport.json` |
