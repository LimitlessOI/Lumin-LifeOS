<!-- SYNOPSIS: Canonical product home — LegacyOS / MediaOS / Human Legacy Initiative -->

# LegacyOS Product Home

**Also known as:** MediaOS, Human Legacy Initiative
...
| **Machine manifest** | `docs/products/legacyos/FILE_MANIFEST.json` |
| **Authority boundaries** | `docs/products/AUTHORITY_BOUNDARIES.md` |
| **Last Updated** | 2026-07-23 — Initial capture of founder vision: Digital Imprint / Digital Twin / Legacy Imprint / Historical Imprint naming architecture and Human Legacy Initiative scope. |

---

> **Y-STATEMENT:** In the context of people whose lives, relationships, and perspectives are mostly lost within a generation, and who want future family members and historians to understand—not merely know about—them, we decided to define **LegacyOS** as a human legacy preservation system that uses a consented Digital Imprint to preserve lived experience, perspective, and relationship context, accepting that the system must always distinguish evidence from inference, preserve multiple viewpoints, and keep the dignity of the living and the deceased intact.
...
| **Verification Command** | `test -f docs/products/legacyos/PRODUCT_HOME.md && test -f docs/products/legacyos/FILE_MANIFEST.json` |
| **Manifest** | `docs/products/legacyos/FILE_MANIFEST.json` |

---

## What LegacyOS is

LegacyOS preserves, organizes, and makes explorable the lived experience of a person, family, or community across time. It is a future product, not a near-term build. Its purpose is to ensure that ordinary lives—not only famous ones—can be understood by future generations with honesty, context, and dignity.
