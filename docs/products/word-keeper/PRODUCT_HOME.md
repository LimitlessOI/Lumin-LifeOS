...
## BUILD HISTORY
- **2026-07-30:** Fixed `services/word-keeper-commitment-classifier.js`'s `@ssot` tag — pointed at `docs/products/WORD_KEEPER/WORD_KEEPER_HOME.md`, which doesn't exist. Corrected to this file. Found by `node scripts/ssot-check.js --all`, part of a wider drift audit.
