<!-- SYNOPSIS: Canonical product home — Conflict Arbitrator -->

# Conflict Arbitrator Product Home

**Formerly called:** Amendment 25 — CONFLICT ARBITRATOR

| Field | Value |
|---|---|
| **Canonical home** | this file |
| **Product id** | `conflict-arbitrator` |
| **Constitutional law** | `docs/constitution/NORTH_STAR_SSOT.md` |
| **Machine manifest** | `docs/products/conflict-arbitrator/FILE_MANIFEST.json` |
...
| **Manifest** | `docs/products/conflict-arbitrator/FILE_MANIFEST.json` |
