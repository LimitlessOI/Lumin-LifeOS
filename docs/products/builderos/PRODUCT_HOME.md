...
| **Last Updated** | 2026-07-14 — provider-key-health accepts `REPLICATE_API` alias alongside `REPLICATE_API_TOKEN`. Prior: BuilderOS governed autonomous loop sources from `BUILD_QUEUE.json`… |
