...
| **Last Updated** | 2026-08-10 — Android `LifeosAccessibilityService` Capacitor plugin shipped: native AccessibilityService-based driving, the Android equivalent of the macOS AXUIElement breakthrough used by the desktop overlay tonight. Prior: 2026-08-09 OVERLAY-DRIVE-CHANNEL-0001 shipped, 15/15 acceptance PASS. |
