...
**Last Updated:** 2026-07-24 — **Public market door hardened.** `/marketing/for-you` is signup-first (Create free account → session → $49 unlock). Chair cash order: SMOS self-serve first while cold email/SMS blocked. Tip-proved live Stripe content-pack checkout. Prior: 2026-07-20 Creative Engine doctrine candidate + `config/smos-pricing.js` ratification (recurring engine not live yet).
