...
**Last Updated:** 2026-07-24 — **Connect accounts + Publish.** Bank-style popup connect for IG/LinkedIn/X/Facebook on `/marketing`; approve then Publish. Live platform posts still behind `LIVE_SOCIAL_PUBLISH_ENABLED`. Prior: Public market door hardened (`/marketing/for-you` signup-first + $49 Stripe).
