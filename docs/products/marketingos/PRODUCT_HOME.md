...
| **Last Updated** | 2026-07-13 | SocialMediaOS content generation quality fix — distinct multi-platform content pack, per-piece title, and robust JSON parsing. |
