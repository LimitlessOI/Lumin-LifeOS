...
| **Stability** | `draft` |
| **Last Updated** | 2026-07-17 — SMOS `/marketing` home has a "Buy Content Pack — $49" button; SENTRY Layer A passes on production (`ui_marketing_landing` + `api_intel_titles` fixed). |
| **Owner** | adam |
