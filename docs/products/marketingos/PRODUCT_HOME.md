...
| **Last Updated** | 2026-07-13 — MarketingOS publish/export security gap closed: publish and alternate export/audio/status routes now scope rows through authenticated owner, publisher unwraps social connections correctly, and replay publish requires real evidence before audit success. |
