...
| **Stability** | `draft` |
| **Last Updated** | 2026-07-17 — SMOS `/marketing` home now has a "Buy Content Pack — $49" button that calls `/api/v1/socialmediaos/content-pack/checkout` and redirects to Stripe. |
| **Owner** | adam |
