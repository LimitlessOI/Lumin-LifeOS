...
| **Last Updated** | 2026-07-13 — SocialMediaOS now shares the same design studio as Site Builder: `routes/marketing-session-routes.js` injects `config/design-studio.js` tokens/fonts/motifs into every generation prompt so content is visually on-brand. |
