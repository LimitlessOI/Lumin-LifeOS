...
1. Blocking Ambiguity / Founder Decision List
    -   **Data Source Definition:** The blueprint lacks specific definitions for data sources, their API endpoints (apiEPs), and expected data schemas required to populate initial Command Center widgets (e.g., status, metrics, alerts).
...
2. Already-Settled Constraints
    ...
    -   **Technology Stack:** Node/ESM for backend/build processes (if applicable), standard web technologies (HTML, CSS, JavaScript) for the frontend.
