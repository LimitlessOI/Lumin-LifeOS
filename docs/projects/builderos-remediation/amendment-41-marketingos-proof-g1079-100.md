...
Implement a minimal `Campaign` entity data model, its persistence layer (e.g., a db table), and a basic apiEP to create and retrieve `Campaign` records. This slice will prove the SSOT by demonstrating consistent data storage and retrieval.
