...
The Command Center V2 Blueprint requires a foundational data source for displaying operational status. The immediate gap is the absence of a dedicated API