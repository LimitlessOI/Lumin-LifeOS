...
-   Implementing basic retry logic and errHdl for API calls.
...
-   `src/config/externalServices.js` (EXISTING, EXTEND) - Add MarketingOS apiEP and credentials.
...
-   `marketingOsApiClient.js`: Verify successful API calls and errHdl with mocked responses.
-   Integration Tests:
