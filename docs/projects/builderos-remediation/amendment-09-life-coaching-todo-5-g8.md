The instruction to write a markdown file conflicts with the verifier's rejection of a `.md` file as code and the output format requesting "implementation code".
