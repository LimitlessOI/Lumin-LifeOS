...
*   An internal API endpoint or scheduled job to trigger and retrieve the proof.
...
2.  Expose this function via a new, authenticated internal API endpoint.
...
*   **Data Integrity Check:** Manually verify a sample of generated proof data against raw campaign data in the MarketingOS database for a specific period, ensuring aggregation rules are correctly applied.
