...
1.  **API Call Verification:**
    ...
    *   Assert HTTP status code is `404 Not Found` or `400 Bad Request` (depending on error handling strategy for invalid IDs).
