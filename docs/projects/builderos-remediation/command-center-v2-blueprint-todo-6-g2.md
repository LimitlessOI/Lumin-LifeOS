...
-   Data Sources for Aggregation: What specific internal systems, services, or db tables should contribute data to the aggregate summary? (e.g., `lifeos_user_activity`, `tsos_order_metrics`, `system_health_logs`).
