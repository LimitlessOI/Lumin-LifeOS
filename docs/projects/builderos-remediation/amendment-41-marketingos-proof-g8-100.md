...
-   `services/marketingos/src/segment/segment.service.ts`: Modify `create`, `update`, and `delete` methods to emit `MarketingSegmentUpdatedEvent` after successful db operations.
