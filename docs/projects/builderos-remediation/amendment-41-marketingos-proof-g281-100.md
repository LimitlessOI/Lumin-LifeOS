...
1.  **LifeOS Internal State Check:** After simulating a user `marketingOptIn` update, verify the `UserConsent` record in the LifeOS database reflects the new status.
