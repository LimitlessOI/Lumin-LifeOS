...
-   `src/api/v1/marketing-campaigns/routes.js` (New file: Defines the apiEP and its handler)
...
-   Data Consistency: Compare a sample of data returned by the new endpoint against the current authoritative source (e.g., direct db query or existing internal service call) to ensure data integrity and consistency.
