...
-   Authentication/Authorization Test: Attempt to access the endpoint without proper internal auth/authz. Verify a 401/403 response.
...
-   The apiEP consistently returns 4xx or 5xx errors for valid internal requests.
