...
*   `src/api/marketingos/marketingApiClient.js`: (New file) Node.js module for making authenticated calls to MarketingOS user update API.
...
*   **Integration Tests:**
    ...
    *   Assert that `marketingApiClient.updateUserOptInStatus`