...
Define the core TypeScript interface and a corresponding Zod schema for `AICouncilPolicyRecord`. This slice focuses solely on establishing the data contract and validation mechanism without implementing persistence or complex business logic.
