...
*   **Dependency Management:** Are there existing common utility functions or database access patterns in `server.js` that should be refactored into shared modules before or during extraction?
*   **Error Handling Pattern:** Confirm the standard error handling middleware/pattern to apply to extracted routes.
...
*   **Module Resolution:** Confirm the new module is correctly imported and resolved by Node.js ESM.
...
---METAD---
{"target_file": "docs/projects/builderos-remediation/amendment-09-life-coaching-todo-1-g6.md", "insert_after_line": null, "confidence": 1.0}