...
The core data models and database schema for Command Center (C2) data are not yet defined within the LifeOS platform. This foundational step is critical for