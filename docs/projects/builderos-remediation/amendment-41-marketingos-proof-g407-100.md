...
This document serves as the SSOT foundation for closing the proof gap identified during the OIL verification of Amendment 41 MarketingOS.

**1. Exact missing implementation or proof gap:**
The `MarketingOS.CampaignMetrics` service's `getCampaignPerformance` endpoint, specifically for `G407-100` (Conversion Rate for 'New User Onboarding' campaigns), is returning stale data