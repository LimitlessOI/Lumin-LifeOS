...
-   `integrations/marketingos/dev-mock-consumer.js`: (New file, for local dev/test only) A simple Node script to listen for and log `UserEngagementEvent`s on the local event bus.
