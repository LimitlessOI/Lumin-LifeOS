...
- [ ] **→ NEXT: Projects Dashboard panel** — hover tooltip + click drawer with build plan, estimates, verification status *(est: 4h)* `[needs-review]`
...
**Progress:** 7/12 steps complete | Est. remaining: ~19h
