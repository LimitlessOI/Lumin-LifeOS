...
| **Status** | Phase 1 — Migration DONE. Commitments patch migration DONE. Phase 2 BLOCKED pending AIC DISCUSSION-6 (backward transition authority) before `services/mission-ledger.js` can be built. |
