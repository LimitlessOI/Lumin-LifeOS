...
**Reality reference:** `docs/architecture/BUILDEROS_TWIN.md` (digital twin of actual code)
...
**Targets:** new `tests/builderos-single-actuator.test.js`; `docs/architecture/BUILDEROS_TWIN.md` (record the locked invariant).
...
- **Reality = Twin:** every file changed here updates `docs/architecture/BUILDEROS_TWIN.md` in the same action.
