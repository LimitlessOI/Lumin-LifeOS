...
4. **Capsule ⇄ SSOT / TSOS convergence (2026-05-13):** **`docs/projects/BRAINSTORM_SESSIONS/tsos-platform/2026-05-13_capsule-ssot-convergence/`** — chronicle + A/C/N rankings (**A/C/N/G/O** sources; do **not** early-collapse overlaps).
5. **Memory / governance continuity (2026-07-27):** **`docs/projects/BRAINSTORM_SESSIONS/tsos-platform/2026-07-27_memory-governance-continuity/`** — read **`01_INDEX_CATEGORIZED.md`**, **`50_IMPLEMENTATION_PLAN.md`**, **`90_DRIFT_ASSESSMENT.md`** before proposing Phase-1 rebuilds (most Phase 1 is ✅ shipped).
6. **Latest dated folders** under **`docs/projects/BRAINSTORM_SESSIONS/<program>/`** — skim triage/charter for last choices.
7. **Where we actually are:** LifeOS product home + **`docs/CONTINUITY_LOG.md`** + zero-drift / memory-intelligence Change Receipts.
8. **Optional machine truth:** **`npm run builder:preflight`**, Founder Decoder **`npm run founder:calm`**.
