...
| 44 | [Token Accounting OS](AMENDMENT_44_TOKEN_ACCOUNTING_OS.md) | **IN_BUILD** | **Infrastructure** — universal token ledger + OCL1 + unified API/health; supreme layer over savings-ledger, TSOS, conductor savings | **High (cost truth + enforcement)** |
| 45 | [CCL Meaning-Preservation Protocol](AMENDMENT_45_CCL_MEANING_PRESERVATION_PROTOCOL.md) | **DRAFT (Phase 0)** | **Infrastructure** — CCLF v1 semantic capsules for BuilderOS/Council/OIL/Memory/TSOS internal; plain English authoritative until multi-model round-trip proven | **High (cost + scale enabler)** |
| 46 | [BuilderOS Control Plane](AMENDMENT_46_BUILDEROS_CONTROL_PLANE.md) | **IN_BUILD** | **Infrastructure** — measure everything: build/task/token/OIL ledgers + DONE gate + health; higher priority than product lanes | **Critical** |
