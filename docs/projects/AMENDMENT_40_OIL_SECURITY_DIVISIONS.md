...
| **Manifest** | `docs/projects/AMENDMENT_40_OIL_SECURITY_DIVISIONS.manifest.json` |
...
```bash
# No secret-like patterns in staged docs (warn)
...
4. `docs/projects/AMENDMENT_19_PROJECT_GOVERNANCE.md` (Phase 7 probe precedent)
