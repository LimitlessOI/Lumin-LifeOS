...
**Last Updated:** 2026-06-29 — repair-artifact persistence: bp-priority-never-stop now commits critical repair JSON files to GitHub after each foundation loop cycle, so repairs survive Railway restarts.
