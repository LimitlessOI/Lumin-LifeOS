...
| **Last Updated** | 2026-04-18 (added feature help/guide system to the LifeOS shell: hover help popovers for shell features, shared `public/overlay/lifeos-feature-data.js` metadata, and `public/overlay/lifeos-feature.html` visual explainers with diagrams; prior 2026-04-17 work delivered the scoreboard, event stream, notifications escalation, calendar, finance, focus/privacy, and core runtime stabilization) |
