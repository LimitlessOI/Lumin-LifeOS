...
| **Last Updated** | 2026-04-15 (Fixed LifeOS verifier/manifest mismatch; made the main LifeOS route surface required at startup; restored Today health API compatibility; unified LifeOS overlay auth/user-key bootstrap across the shipped overlays) |
