...
| **Last Updated** | 2026-04-15 (Fixed LifeOS verifier/manifest mismatch; made core LifeOS routes required at startup; restored Today health API compatibility; unified family overlay command-key bootstrap) |
