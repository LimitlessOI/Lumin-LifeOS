...
| **Last Updated** | 2026-04-16 (Promoted conflict + finance into the required LifeOS runtime; added parent-summary / learning / checkins / dreams compatibility for children; added onboarding / notifications / quick-entry / parent-view into the tracked test surface; added POST /api/v1/lifeos/users for onboarding bootstrap) |
