...
| **Last Updated** | 2026-04-18 (added in-page control guidance for high-use LifeOS controls: shared `public/overlay/lifeos-control-help.js`, control-specific metadata in `public/overlay/lifeos-feature-data.js`, control guide support in `public/overlay/lifeos-feature.html`, and hover/focus help wiring for Today, Quick Entry, Notifications, and Engine; prior 2026-04-18 work delivered shell-level feature help and guide pages, and prior 2026-04-17 work delivered the scoreboard, event stream, notifications escalation, calendar, finance, focus/privacy, and core runtime stabilization) |
