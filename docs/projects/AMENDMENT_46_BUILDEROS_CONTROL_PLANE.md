...
Phase 1 control plane is on disk. Amendment 44 remains token sub-layer. Deploy migrations `20260531`, `20260532`, `20260601` then run verify scripts. 2026-06-16: factory execute-step sandbox traversal was patched in both `factory-staging/factory-core/builder/run-step.js` and `builderos-reboot/MISSIONS/FACTORY-REBOOT-0029/CONTENT/run-step.js`; keep `builderos-reboot/scripts/factory-sandbox-security.mjs` in factory CI when touching execute-step path validation or mission materialization.
