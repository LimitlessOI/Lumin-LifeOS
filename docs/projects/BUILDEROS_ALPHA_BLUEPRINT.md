...
**Last Updated:** 2026-05-27 (Phase D follow-up: fix TSOS hook INSERT — wrong column name task_description→task_goal + missing required run_id caused silent INSERT failure on every governed loop commit)
