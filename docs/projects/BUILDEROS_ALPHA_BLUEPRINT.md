...
**Last Updated:** 2026-05-27 (Phase D follow-up: fix TSOS hook INSERT schema mismatch + fix C2 metadata_json key mismatch preventing target_file from reaching PBB planner)
