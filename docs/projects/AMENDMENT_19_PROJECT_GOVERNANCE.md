...
**Last Updated:** 2026-05-21 — OIL Security Alpha: security_receipts table, receipt service, Gemini proof route, OIL receipt API route, daily summary service, builder release modes config, safe-scope policy, supervised mode enforcement in builder route, daily summary scheduler. All 9 files `node --check` PASS.
