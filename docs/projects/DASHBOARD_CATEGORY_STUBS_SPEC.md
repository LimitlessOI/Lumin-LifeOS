...
<div id="lifeos-widget-category-stubs" class="dashboard-widget card accent-border-finance fade-up delay-6">
    <div class="card-label">Life Categories</div>
    <div class="scores-grid">
        <!-- Health Stub -->
        <div class="score-tile" onclick="window.parent.loadPage('lifeos-health.html')">
            <div class="score-ring">
                <svg width="72" height="72" viewBox="0 0 72 72">
                    <circle class="track" cx="36" cy="36" r="33" stroke-width="6" fill="none"/>
                    <circle class="fill" cx="36" cy="36" r="33" stroke="var(--c-health)" stroke-width="6" fill="none"
                            stroke-dasharray="207" stroke-dashoffset="0"/>
                </svg>
                <div class="score-num" style="color:var(--c-health);">🌿</div>
            </div>
            <div class="score-label">Health</div>
        </div>
        <!-- Family Stub -->
        <div class="score-tile" onclick="window.parent.loadPage('lifeos-family.html')">
            <div class="score-ring">
                <svg width="72" height="72" viewBox="0 0 72 72">
                    <circle class="track" cx="36" cy="36" r="33" stroke-width="6" fill="none"/>
                    <circle class="fill" cx="36" cy="36" r="33" stroke="var(--c-family)" stroke-width="6" fill="none"
                            stroke-dasharray="207" stroke-dashoffset="0"/>
                </svg>
                <div class="score-num" style="color:var(--c-family);">🏡</div>
            </div>
            <div class="score-label">Family</div>
        </div>
        <!-- Purpose Stub -->
        <div class="score-tile" onclick="window.parent.loadPage('lifeos-purpose.html')">
            <div class="score-ring">
                <svg width="72" height="72" viewBox="0 0 72 72">
                    <circle class="track" cx="36" cy="36" r="33" stroke-width="6" fill="none"/>
                    <circle class="fill" cx="36" cy="36" r="33" stroke="var(--c-purpose)" stroke-width="6" fill="none"
                            stroke-dasharray="207" stroke-dashoffset="0"/>
                </svg>
                <div class="score-num" style="color:var(--c-purpose);">🎯</div>
            </div>
            <div class="score-label">Purpose</div>
        </div>
        <!-- More Categories Stub -->
        <div class="score-tile" onclick="window.parent.openMoreSheet()">
            <div class="score-ring">
                <svg width="72" height="72" viewBox="0 0 72 72">
                    <circle class="track" cx="36" cy="36" r="33" stroke-width="6" fill="none"/>
                    <circle class="fill" cx="36" cy="36" r="33" stroke="var(--text-muted)" stroke-width="6" fill="none"
                            stroke-dasharray="207" stroke-dashoffset="0"/>
                </svg>
                <div class="score-num" style="color:var(--text-muted);font-size:24px;">…</div>
            </div>
            <div class="score-label">More</div>
        </div>
    </div>
</div>
</div>
