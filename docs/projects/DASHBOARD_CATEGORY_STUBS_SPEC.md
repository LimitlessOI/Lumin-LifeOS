...
--c-family: #f43f5e; /* Added for Family category */
--c-purpose: #8b5cf6; /* Added for Purpose category */
...
<!-- ROW 3: Health + Family Stubs -->
<div class="two-col mb-4">
<div class="card accent-border-health fade-up delay-6" onclick="window.parent.loadPage('lifeos-health.html')">
<div class="card-label">Health</div>
<div class="skel-line skeleton w-full"></div>
<div class="skel-line skeleton w-4/5"></div>
<div class="skel-line skeleton w-3/5"></div>
</div>
<div class="card accent-border-family fade-up delay-7" onclick="window.parent.loadPage('lifeos-family.html')">
...
<!-- ROW 4: Purpose Stub (full width) -->
<div class="two-col mb-4">
<div class="card accent-border-purpose fade-up delay-8" style="grid-column: 1 / -1;" onclick="window.parent.loadPage('lifeos-purpose.html')">
