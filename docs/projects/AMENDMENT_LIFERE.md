...
|------|--------|-----|-------|------|
| 2026-06-13 | **Receptionist → approval** — `POST /receptionist/calls/:id/follow-up-draft`; Ops tab call list + draft button; learning playbook cards | Adam: keep going | ✅ | deploy |
