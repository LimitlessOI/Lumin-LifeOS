<!-- SYNOPSIS: Constitution folder index — one live law file -->

# Constitution

**Live constitutional law (ONE file):**

[`NORTH_STAR_SSOT.md`](NORTH_STAR_SSOT.md) — North Star Constitution SSOT / **Force of Truth**
...
**History / parts car:** `docs/history/README.md`

**Operational companion (not constitutional law):** `docs/SSOT_COMPANION.md`
