...
| Date | Change |
|------|--------|
| 2026-05-02 | **V8** LifeOS operational grade script + **`npm run lifeos:operational-grade`**; **V6** suite now **6** steps (includes V8). **V7** note: orthogonal to V8. **`docs/LIFEOS_SHELL_ACCEPTANCE.md`**. |
