...
| **B2** | **Council builder — `/ready`** | `GET /api/v1/lifeos/builder/ready` | `GITHUB_TOKEN`, `callCouncilMember`, pool, auth keys | Same | **SHIPPED** | **KNOW (2026-04-30):** prod `/ready` returns **200** and reports commit/council/pool truth. |
